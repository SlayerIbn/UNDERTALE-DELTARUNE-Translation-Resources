...
if (naming == 3)
{
    ...
    if (mlevel == 4)
    {
        sans_y = 30 // Stop accent marks overlapping
        if (global.language == "ja")
            sans_y -= 5
        pap_x = 271 // Stop reset message overlapping
        if (global.language == "ja")
            pap_x -= 9
        draw_sprite(spr_chairiel_sleep, (siner_o / 8), 125, 138)
...
if (naming == 3)
{
    ...
    scr_drawtext_centered(160, 222, (("UNDERTALE v" + version) + " (C) Toby Fox 2015-2017"))
    scr_drawtext_centered(160, 229, "PLACEHOLDER") // Fantranslation credit
}
